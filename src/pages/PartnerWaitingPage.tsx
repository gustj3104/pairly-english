      ...
      <div style={{ maxWidth: 640, width: '100%', textAlign: 'center' }}>
        ...
        <div style={{ marginBottom: 36 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 32, marginBottom: 28 }}>
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ position: 'relative', width: 72, height: 72, margin: '0 auto 10px' }}>
                <div style={{ width: 72, height: 72, borderRadius: '50%', background: 'linear-gradient(135deg, #4f46e5, #7c3aed)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: 22, fontWeight: 700 }}>{getInitials(myName)}</div>
            ...
            <div style={{ textAlign: 'center' }}>
              <div style={{ position: 'relative', width: 72, height: 72, margin: '0 auto 10px' }}>
                <div style={{ width: 72, height: 72, borderRadius: '50%', background: 'linear-gradient(135deg, #10b981, #059669)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: 22, fontWeight: 700 }}>{getInitials(partnerName)}</div>
              ...
              <div style={{ fontSize: 14, fontWeight: 600, color: '#1c1917' }}>{partnerName}</div>
          ...
          <div style={{ backgroundColor: 'white', borderRadius: 20, padding: '28px 32px', border: '1px solid #e7e5e4', boxShadow: '0 2px 12px rgba(0,0,0,0.04)' }}>
            ...
            <p style={{ color: '#78716c', fontSize: 15, lineHeight: 1.7, margin: '0 0 20px' }}>
              Take a break or use this time to review your vocabulary. We'll notify you the moment {partnerName} submits their reflection.
            </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12, marginBottom: 28 }}>
          <button onClick={() => !notified && setNotified(true)} style={{ padding: '14px 12px', borderRadius: 14, backgroundColor: notified ? '#ecfdf5' : 'white', border: `1.5px solid ${notified ? '#a7f3d0' : '#e7e5e4'}`, cursor: 'pointer', textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 11, color: '#78716c', marginTop: 2 }}>{notified ? `${partnerName} was notified` : 'Send a reminder'}</div>
          </button>

...
export type CreditFeature =
  ...
  | 'daily_news'
  // Covers the full AI dictionary lookup (Korean meaning + English definition + part of speech +
  // example, one Mindlogic call) even though the name says "translation" — kept as-is because
